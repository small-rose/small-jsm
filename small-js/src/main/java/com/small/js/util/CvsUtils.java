    ...
    public static List<JUserInfo> getCsvDataMethod1(File file) {
        ...
        try {
            ...
            while ((line = bufferedReader.readLine()) != null) {
                ...
                csvFile.setNickName(splitResult(split[1]));
                csvFile.setNickNamePy(PinYinSmallUtil.getPinYin(splitResult(split[1])));
                csvFile.setPrecommender(Long.parseLong(split[3]));
                ...
                if (split.length > 5 && StringUtils.hasText(splitResult(split[5]))){
                    csvFile.setSlugUrl("https://www.jianshu.com/u/"+splitResult(split[5]));
                }else {
                    csvFile.setSlugUrl(null);
                }
