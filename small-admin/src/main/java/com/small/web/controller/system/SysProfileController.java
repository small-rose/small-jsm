...
import com.small.common.utils.file.FileUploadUtils;
import com.small.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult updateAvatar(@RequestParam("avatarfile") MultipartFile file)
    {
        ...
        try
        {
            if (!file.isEmpty())
            {
                String avatar = FileUploadUtils.upload(SmallConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
